...
typedef struct {
		int		type;
		daemonKeepalive_t		daemonKeepalive_t_val;
		daemonTest_t		daemonTest_t_val;
		daemonQueryCPUTemp_t		daemonQueryCPUTemp_t_val;
		basicTest_t		basicTest_t_val;
}clisrvMessage_t;
...
static arStatus_t		clisrvMessage_t_Marshal(clisrvMessage_t*uni_type, arBuffer_t *out)
{
		...
		switch(uni_type->type)
		{
                ...
                case DAEMONKEEPALIVE_T :
                        val = __put_daemonKeepalive_t(&uni_type->daemonKeepalive_t_val);
                        break;
                case DAEMONTEST_T :
                        val = __put_daemonTest_t(&uni_type->daemonTest_t_val);
                        break;
                case DAEMONQUERYCPUTEMP_T :
                        val = __put_daemonQueryCPUTemp_t(&uni_type->daemonQueryCPUTemp_t_val);
                        break;
                case BASICTEST_T :
                        val = __put_basicTest_t(&uni_type->basicTest_t_val);
                        break;
                        /**********************************************/
                default:
                        ar_status = AR_E_INVAL;
...
static arStatus_t		clisrvMessage_t_UnMarshal(clisrvMessage_t*uni_type, arBuffer_t *in)
{
		...
		switch(uni_type->type)
		{
                        /*******************************************************************************************/
                case DAEMONKEEPALIVE_T :
                        if(!__get_daemonKeepalive_t(data_obj, &uni_type->daemonKeepalive_t_val))
                        {
								ar_status = AR_E_INVAL;
								goto END_POINT;
                        };
                        break;
                case DAEMONTEST_T :
                        if(!__get_daemonTest_t(data_obj, &uni_type->daemonTest_t_val))
                        {
								ar_status = AR_E_INVAL;
								goto END_POINT;
                        };
                        break;
                case DAEMONQUERYCPUTEMP_T :
                        if(!__get_daemonQueryCPUTemp_t(data_obj, &uni_type->daemonQueryCPUTemp_t_val))
                        {
								ar_status = AR_E_INVAL;
								goto END_POINT;
                        };
                        break;
                case BASICTEST_T :
                        if(!__get_basicTest_t(data_obj, &uni_type->basicTest_t_val))
                        {
								ar_status = AR_E_INVAL;
								goto END_POINT;
                        };
