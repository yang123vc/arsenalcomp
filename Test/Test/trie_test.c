...
bool_t	AR_InsertToTrie(arTrie_t *trie, const wchar_t *str, void *data)
{
		arTrieNode_t *curr;
...
bool_t	AR_RemoveFromTrie(arTrie_t *trie, const wchar_t *str)
{
		arTrieNode_t *curr;
		AR_ASSERT(trie != NULL);
		curr = trie;
...
void*	AR_MatchTrie(const arTrie_t *trie, const wchar_t *str, bool_t case_intensive)
{
