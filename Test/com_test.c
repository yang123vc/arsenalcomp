...
#pragma pack(push, 16)
		...
		struct test
		{
				char a;			//offset == 0, Õ¼ÓÃ1×Ö½Ú
				//char __pad1[3];
				int  b;			//Ìî³äÇ°offset == 1,A =4, A - 1 % A == 3,Ôò²¹³ä3×Ö½Ú£¬Ìî³äºó£¬offset = 4,
				long c;			//offset ==8 , A == 4,  8 % 4 == 0,						ÎÞÌî³ä
				short d;		//offset == 12, A == 2 12 % 2 == 0,						ÎÞÌî³ä
				//char __pad2[2];
				int *p;			//Ìî³äÇ°offset == 14, A = 8, 14 % 8 == 6, A-6 == 2£¬   Ìî³ä2,Ìî³äºó£¬offset == 16, Õ¼8×Ö½Ú
		};
#pragma pack(pop)
...
#pragma pack(push,16)
		struct test
		{
				char	a;		//offset == 0, Õ¼ÓÃ1×Ö½Ú
				//char __pad[1];
				short	b;		//Ìî³äÇ° offset == 1, A = 2; 1 % A = 1; A-1 = 1; Ìî³ä1ºó£¬offset == 2;
