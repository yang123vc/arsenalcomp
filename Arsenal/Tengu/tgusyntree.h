...
tguVar_t*		TGU_CreateVar(const wchar_t *name, const tguLexInfo_t	*lex_info, tguInitializer_t	*initializer);
void			TGU_DestroyVar(tguVar_t	*var);

size_t			TGU_AddVarRefCount(tguVar_t	*var);
size_t			TGU_DecVarRefCount(tguVar_t	*var);
