...
static AR_INLINE bool_b_t			PSR_InsertToTermInfoRec(psrTermInfoRec_t *rec, const psrTermInfo_t *term)
{
...
static AR_INLINE bool_b_t PSR_InsertToTermInfoTable(psrTermInfoTbl_t *tbl, const psrTermInfo_t *term)
{
		size_t idx;
