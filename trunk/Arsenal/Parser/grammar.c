...
bool_b_t			PSR_InsertToTermInfoList(psrTermInfoList_t	*lst, const wchar_t *name, size_t val, psrAssocType_t assoc, size_t prec, psrTermFunc_t	leaf_f);
*/
...
bool_b_t			PSR_IsEmptyRule(const psrRule_t *rule)
{
		AR_ASSERT(rule != NULL);
...
bool_b_t					PSR_InsertTerm(psrGrammar_t *grammar, const wchar_t *name, size_t val, psrAssocType_t assoc, size_t prec, psrTermFunc_t	leaf_f)
{
...
bool_b_t					PSR_InsertRule(psrGrammar_t *grammar, psrRule_t *rule)
{
		size_t i;
...
bool_b_t					PSR_InsertRuleByPartStr(psrGrammar_t *grammar, const psrSymb_t *head, const psrSymbList_t *body, const wchar_t *prec_tok, psrRuleFunc_t rule_f, size_t auto_ret)
{
		psrRule_t		*rule;
...
bool_b_t					PSR_InsertRuleByStr(psrGrammar_t *grammar, const wchar_t *str, const wchar_t *prec, psrRuleFunc_t rule_f, size_t auto_ret)
{
...
static bool_b_t __detect_left_recursion(const psrGrammar_t *grammar, const psrSymb_t *head, psrSymbList_t *lst, arString_t *output)
{
		size_t i;
...
bool_b_t					PSR_ReportLeftRecursion(const psrGrammar_t *grammar, arString_t *output)
{
		size_t i;
		psrSymbList_t	lst;
		bool_b_t			ret = false;
...
bool_b_t			PSR_CheckIsValidGrammar(const psrGrammar_t *grammar)
{
		size_t i,j,k;
		bool_b_t result;
...
bool_b_t					PSR_SetFirstRule(psrGrammar_t *grammar, const wchar_t *rule_name)
{
