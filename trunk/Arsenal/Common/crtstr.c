...
static const wchar_t* __wtou32_s(const wchar_t *in, const wchar_t *end, uint32_t  *num, size_t base, uint32_t flag)
{
		uint32_t val,digit, maxval;
		const wchar_t *p;
		...
		maxval = AR_UINT32_MAX / (uint32_t)base;
		digit = 0;
		val = 0;
