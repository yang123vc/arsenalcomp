...
#define AR_CHECK(cond,msg) do {if(!(cond))AR_fatal(msg); }while(0)
...
#define AR_BIT_MARK(_pos)	(((uint64_t)0x01) << (_pos))

#define AR_BIT_TEST(_val, _pos)  ((bool)(((_val) & (AR_BIT_MARK((_pos))))))
