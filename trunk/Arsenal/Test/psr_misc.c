...
void grammar_test2()
{
		...
		{
				AR_ASSERT(PSR_InsertRule3(gmr, rules[i].rule, rules[i].prec, NULL));
...
void calc_test1()
{
		...
		PSR_InsertRule3(gmr, L"S : ( S ) S", NULL, create_node);
		PSR_InsertRule3(gmr, L"S : ", NULL, reduce_epsilon_node);
