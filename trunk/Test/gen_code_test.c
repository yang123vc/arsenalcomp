...
{L"PREC_UNARY", 302,7, PARSER_ASSOC_RIGHT},
{L"IF_WITHOUT_ELSE", 303,8, PARSER_ASSOC_NONASSOC},
...
{L"program  :  translation_unit ", NULL, handle_translation_unit, 0},
...
#define __RULE_COUNT__ ((size_t)93)
